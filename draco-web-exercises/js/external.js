...
// var rentalPerDayDollars = prompt("What is the the daily rental rate in dollars?");
...
//
// var totalRentalCost = (
//     parseFloat(littleMermaidDays) +
//     parseFloat(brotherBearDays) +
//     parseFloat(herculesDays)) * parseFloat(rentalPerDayDollars);
//
