...
// var userBillDollars = parseFloat(prompt('Please enter the bill total in dollars.'));
// var tipPercentage = parseFloat(prompt('Please enter your preferred tip percentage (e.g. enter 10 for 10% tip)')) / 100;
//
// alert('You will need to tip: $' + calculateTip(tipPercentage, userBillDollars).toFixed(2));
...
console.log(applyDiscount(45.99, 0.12), 40.4712); // 40.4712